...
<style scoped>
.create-page { width: 100%; max-width: 1600px; margin: 0 auto; min-width: 0; }
...
.form-body :deep(.form-grid) { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: var(--space-4); }
