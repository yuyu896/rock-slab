...
<template>
  <div class="detail-page">
    <div class="page-header">
      <button class="back-btn" @click="router.replace('/transfers/assign')">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="15 18 9 12 15 6"/></svg>
        返回
      </button>
      <h1 class="page-title">领用出库详情</h1>
    </div>
    ...
    <div v-else class="form-card">
      <div v-if="!editing" class="form-grid">
        ...
        <div class="form-item"><label>使用人</label><span class="value">{{ transfer.使用人 || '-' }}</span></div>
        <div class="form-item"><label>所属部门</label><span class="value">{{ transfer.所属部门 || '-' }}</span></div>
        ...
        <div class="form-item"><label>审批人</label><span class="value">{{ transfer.审批人 || '-' }}</span></div>
        <div class="form-item"><label>审批时间</label><span class="value">{{ transfer.审批时间 || '-' }}</span></div>
      ...
      <div v-else class="form-grid">
        ...
        <div class="form-item"><label>使用人</label><input v-model="editForm.使用人" type="text" class="form-input" /></div>
