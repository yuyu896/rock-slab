...
const form = ref({ 资产编号: '', 资产名称: '', 数量: 1, 规格型号: '', 备注: '' })

function openCreateModal() {
  form.value = { 资产编号: '', 资产名称: '', 数量: 1, 规格型号: '', 备注: '' }
  ...
  <div class="transfer-page">
    <div class="page-header">
      <div class="header-info">
        ...
        <p class="page-desc">管理采购入库流转记录</p>
      </div>
    ...
    <div class="table-container">
      <table class="data-table">
        <thead><tr><th>日期</th><th>资产编号</th><th>资产名称</th><th>数量</th><th>状态</th><th>操作</th></tr></thead>
        <tbody>
    ...
    <div class="pagination-section">
      ...
      <div class="pagination-controls">
        <button class="page-btn" :disabled="pagination.page <= 1" @click="pagination.page--; fetchTransfers()"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="15 18 9 12 15 6"/></svg></button>
        <button class="page-btn active">{{ pagination.page }}</button>
        <button class="page-btn" :disabled="pagination.page * pagination.pageSize >= pagination.total" @click="pagination.page++; fetchTransfers()"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg></button>
      </div>
    </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-grid">
            ...
            <div class="form-item"><label class="form-label">规格型号</label><input v-model="form.规格型号" type="text" class="form-input" /></div>
    ...
    <div v-if="showImportModal" class="modal-overlay" @click.self="showImportModal = false">
      <div class="modal-content">
        <div class="modal-header"><h3>批量导入流转记录</h3><button class="modal-close" @click="showImportModal = false">&times;</button></div>
        <div class="modal-body">
...
.form-input, .form-textarea { height: 40px; padding: 0 var(--space-3); border: 1px solid var(--color-border); border-radius: 8px; background: var(--color-bg-page); font-size: var(--text-sm); }
