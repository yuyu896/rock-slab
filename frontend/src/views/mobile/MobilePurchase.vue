  ...
  <div class="purchase-page">
    ...
    <div class="form-section">
      ...
      <div class="form-group">
        ...
        <select v-model="form.资产类目" class="form-select">
          <option value="">请选择类目</option>
          <option v-for="cat in categories" :key="cat.id" :value="cat.资产类目">
            {{ cat.资产类目 }}
          </option>
        </select>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="qty-input-group">
          <button class="qty-btn" @click="form.数量 = Math.max(1, form.数量 - 1)">-</button>
          <input v-model.number="form.数量" type="number" class="form-input qty-input" min="1" />
          <button class="qty-btn" @click="form.数量++">+</button>
        </div>
      </div>

      <div class="form-group">
        <label class="form-label">所属分公司</label>
        <select v-model="form.分公司" class="form-select">
