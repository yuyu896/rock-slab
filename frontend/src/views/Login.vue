  ...
  <div class="login-page">
    ...
    <aside class="login-visual">
      <div class="visual-inner">
        <BrandLogo :size="84" variant="brand" :hide-text="false" class="visual-logo" />
        <p class="visual-tagline">专业资产管理 · 高效盘点流程</p>
        <div class="visual-scenes">
          <span class="scene-chip">资产台账</span>
          <span class="scene-chip">扫码盘点</span>
          <span class="scene-chip">审批流转</span>
          <span class="scene-chip">数据报表</span>
        </div>
      </div>
    </aside>
    ...
    <main class="login-form-side">
      <div class="login-card">
        <div class="login-header">
          ...
          <p class="login-subtitle">磐盘 · 行政资产盘点</p>
        </div>
...
@media (max-width: 960px) {
  ...
  .login-form-side { padding: var(--space-6); min-height: 100vh; }
}

/* ===== 深色模式：左侧视觉略深，右侧随令牌自适应 ===== */
