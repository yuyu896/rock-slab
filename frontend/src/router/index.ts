...
const routes: RouteRecordRaw[] = [
  // PC端路由
  {
    ...
    children: [
      ...
      { path: 'assets/list', redirect: '/assets/summary' },
      { path: 'assets/list/create', redirect: '/assets/summary' },
      { path: 'fixed-assets', component: () => import('@/views/FixedAssetList.vue'), meta: { title: '实例档案' } },
      ...
      { path: 'transfers/assign/:id', component: () => import('@/views/transfers/AssignDetail.vue'), meta: { title: '领用详情' } },
