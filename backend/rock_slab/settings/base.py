...
# 禁用URL尾斜杠重定向（与DRF Router trailing_slash=False配合）
APPEND_SLASH = False

ROOT_URLCONF = 'rock_slab.urls'
...
WSGI_APPLICATION = 'rock_slab.wsgi.application'

AUTH_USER_MODEL = 'users.User'

AUTHENTICATION_BACKENDS = [
    'apps.authentication.backends.PhoneModelBackend',
]
